...
class Admin extends BaseController
{
    ...
    public function reportDocumentType($document_type_id = '') {
        ...
        if($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Ashirwad Captial Limited - Reports';
    ...
    public function teamDocumentType($document_type_id = '') {
        ...
        if($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Ashirwad Captial Limited - Management Team';
    ...
    public function announcementsDocumentType($document_type_id = '') {
        ...
        if($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Ashirwad Captial Limited - Announcements';
    ...
    public function policyDocumentType($document_type_id = '') {
        ...
        if($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Ashirwad Captial Limited - Company Policies';
    ...
    public function downloadDocumentType($document_type_id = '') {
        ...
        if($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Ashirwad Captial Limited - Download';
    ...
    public function contactDocumentUpload($contact_id = '') {
        ...
        if($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Ashirwad Captial Limited - Contact';
