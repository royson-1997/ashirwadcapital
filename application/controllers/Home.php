...
class Home extends CI_Controller
{
    ...
    public function index() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Home";
    ...
    public function annualReport() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Annual Report";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function quarterlyFinancialResults() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Quarterly Financial Results";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function shareholdingPattern() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Shareholding Pattern";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function unclaimedDivided() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Unclaimed Dividend Transfer to Investor Education and Protection Fund (IEPF)";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function declarationOfEvotingResults() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Declaration of E_Voting Results";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function unclaimedShares() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Unclaimed Shares Transfer to Investor Education and Protection Fund (IEPF)";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function managementTeam() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Management Team";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function announcements() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Announcements";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function companyPolicy() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Company Policy";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
    ...
    public function download() {
        ...
        $this->data['title'] = "Ashirwad Captial Limited - Download";
        $this->data['description'] = "";
        $this->data['keywords'] = "";
